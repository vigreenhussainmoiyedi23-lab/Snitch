      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link
              to="/admin"
              className="teko text-base tracking-wider px-5 py-2 rounded-full border border-border text-background-light hover:border-primary hover:text-primary transition-colors duration-150"
            >
              Go To Dashboard
            </Link>
            <button
