...
const AddToCartButton: React.FC<AddToCartButtonProps> = ({
  ...
  return (
    <div className="flex flex-wrap sm:flex-nowrap items-stretch gap-2 w-full animate-in fade-in zoom-in-95 duration-300">
      ...
      >
        <span
          className={`flex items-center justify-center gap-2 w-full transition-transform duration-500 ease-out ${isAdding ? "translate-y-[-150%] opacity-0" : "translate-y-0 opacity-100"}`}
        >
