  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-700">
        ...
        <h2 className="text-2xl font-semibold text-text mb-3 tracking-wide">
          Checkout Unavailable
        </h2>
        <p className="text-text-subtle mb-8 max-w-sm text-base leading-relaxed">
          Your cart is currently empty. Please add some of our premium products
          to proceed.
        </p>
        <Link
          to="/products"
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16 bg-background min-h-screen">
      <div className="flex items-center justify-between mb-8 lg:mb-12">
        <div className="flex items-center gap-3">
          <Link
            to="/"
            className="text-text-muted hover:text-text transition-colors flex items-center gap-1 group text-sm font-medium"
          >
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <div className="w-full lg:flex-[3]">
          <h1 className="text-3xl font-semibold text-text mb-8 tracking-wide">
          ...
          <form className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white/95 p-6 md:p-8 rounded-lg shadow-soft border border-border space-y-6 transition-shadow hover:shadow-medium">
              <h2 className="text-xl font-semibold text-text mb-2 flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-primary text-background text-xs flex items-center justify-center font-bold">
                  1
                </span>
                Contact Details
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-background border border-border rounded-[var(--radius-md)] focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all placeholder:text-text-subtle text-text"
                  />
                </div>
                <div className="space-y-2">
                  <label
        ...
        <div className="w-full lg:flex-2 lg:sticky lg:top-8 space-y-8 animate-in fade-in slide-in-from-right-4 duration-700">
          <div className="bg-white/95 p-6 md:p-8 rounded-lg shadow-soft border border-border">
            <h2 className="text-xl font-semibold text-text mb-6 flex items-center justify-between">
              ...
              <span className="text-sm font-normal text-text-muted bg-background-subtle px-3 py-1 rounded-full">
                {itemCount} items
              </span>
            </h2>
